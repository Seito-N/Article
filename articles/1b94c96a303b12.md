...
例えば以下画像の検索画面で National Accounts $\rightarrow$ Main Aggregates $\rightarrow$ 1. Gross domestic product (GDP) と進めばお目当てのデータにたどり着くことができます（この辺りは慣れが必要な部分でもあり、私も試行錯誤です）。
