...
この記事では、`{OECD}` パッケージを使って各国の GDP データを取得し、可視化するところまでを扱います。
...
![OECD stat の検索画面]([https://storage.googleapis.com/zenn-user-upload/897d8cc44822-20221217.jpg)](https://storage.googleapis.com/zenn-user-upload/897d8cc44822-20221217.jpg))
...
(![GDP の国際比較]([https://storage.googleapis.com/zenn-user-upload/921fe563fe99-20221217.png)](https://storage.googleapis.com/zenn-user-upload/921fe563fe99-20221217.png))
